...
$stmt = $pdo->prepare('SELECT password_hash, password FROM users WHERE username = ?');
...
// Store the hashed password and plain password
$hashedPassword = $user['password_hash'];
$plainPassword = isset($_POST['password']) ? $_POST['password'] : 'Not available'; // Placeholder if no password is stored
?>
